...
('Toyota', 'Hiace', '1กย 5012', 'รถตู้', 12, 4, 'อัตโนมัติ', 'เบนซิน', 2080.00, 'active', NOW(), NOW()),
...
('Toyota', 'Fortuner', '1กย 5012', 'SUV', 7, 4, 'อัตโนมัติ', 'เบนซิน', 1880.00, 'active', NOW(), NOW()),
...
('Hyundai', 'New H1 รุ่น Elite เสริมประตูไฟฟ้า', '7สข 4871', 'MPV VAN', 7, 5, 'อัตโนมัติ', 'ดีเซล', 2500.00, 'active', NOW(), NOW()),
